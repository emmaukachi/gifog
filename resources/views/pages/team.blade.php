...
<section class="page-header padding">
    ...
    <p>Construction & Building with a difference.</p>
    </div>
    </div>
    </section>
    ...
    <li><a href="https://www.facebook.com/rosemary.oluwakemi.7?epa=SEARCH_BOX"><i class="ti-facebook"></i></a></li>
    ...
    <ul class="team-social">
    <li><a href="face"><i class="ti-facebook"></i></a></li>
    <li><a href="#"><i class="ti-twitter"></i></a></li>
    <li><a href="#"><i class="ti-instagram"></i></a></li>
    <li><a href="#"><i class="ti-youtube"></i></a></li>
    </ul>
